...
public class NewTest01 {
  ...
  public void flushReport() {
    // 👇 Your request: flush the report
    if (extent != null) {
      extent.flush();
      System.out.println("Extent report generated at: " + projectpath + File.separator + "jan28th_Report.html");
    }
  }
  ...
  public void setUp(Method method) {
    ...
    // You can keep a fixed name or use dynamic test names:
  ...
  public void tearDown(ITestResult result) {
    try {
      if (result.getStatus() == ITestResult.FAILURE) {
        // 👇 Your exact snippet integrated in failure branch
        ...
        // (Optional) Also log the exception detail:
      ...
      // ⚠️ Best practice is to flush in @AfterSuite.
      // If you ALSO want to flush after every test, uncomment the next two lines:
      // if (extent != null) {
      //   extent.flush();
      // }
    }
